...
export const comprehensiveSupplements: SupplementWithRelations[] = [
	// 1. VITAMIN B12 (COBALAMIN)
	{
		...
		polishDescription:
			"Niezbędna witamina dla funkcji neurologicznych, tworzenia czerwonych krwinek i syntezy DNA",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				description:
					"Essential cofactor for methionine synthase in homocysteine remethylation",
				polishDescription:
					"Niezbędny kofaktor dla syntazy metioniny w remetylacji homocysteiny",
				evidenceLevel: "STRONG" as EvidenceLevel,
			...
			interactions: [
				{
					...
					polishDescription:
						"Antybiotyk może zmniejszać wchłanianie witaminy B12",
					clinicalSignificance: "Monitor B12 levels during concurrent use",
					polishClinicalSignificance:
						"Monitoruj poziom B12 podczas jednoczesnego stosowania",
		...
		interactions: [
			{
				...
				polishMechanism:
					"Przewlekłe spożywanie alkoholu upośledza wchłanianie B12",
				description: "Heavy alcohol use increases B12 requirements",
				polishDescription:
					"Duże spożycie alkoholu zwiększa zapotrzebowanie na B12",
				clinicalSignificance: "Higher doses may be needed in alcoholics",
				polishClinicalSignificance:
					"Wyższe dawki mogą być potrzebne u alkoholików",
				recommendation: "Monitor B12 status in heavy drinkers",
				polishRecommendation:
					"Monitoruj status B12 u osób pijących dużo alkoholu",
				evidenceLevel: "MODERATE" as EvidenceLevel,
			},
		],
		evidenceLevel: "STRONG" as EvidenceLevel,
	...
	// 2. PROBIOTICS
	{
		...
		description:
			"Beneficial microorganisms that support gut health and immune function",
		polishDescription:
			"Pożyteczne mikroorganizmy wspierające zdrowie jelit i funkcję odpornościową",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				description:
					"Strengthens tight junctions and reduces intestinal permeability",
				polishDescription:
					"Wzmacnia połączenia ścisłe i zmniejsza przepuszczalność jelitową",
				evidenceLevel: "MODERATE" as EvidenceLevel,
			...
			interactions: [
				{
					...
					polishDescription:
						"Jednoczesne stosowanie może zmniejszać skuteczność probiotyków",
		...
		interactions: [
			{
				...
				polishMechanism:
					"Probiotyki mogą przeciwdziałać efektom immunosupresyjnym",
				description: "May reduce efficacy of immunosuppressive therapy",
				polishDescription:
					"Może zmniejszać skuteczność terapii immunosupresyjnej",
				clinicalSignificance: "Use with caution in transplant patients",
				polishClinicalSignificance:
					"Stosować ostrożnie u pacjentów po transplantacji",
	...
	// 3. MELATONIN
	{
		...
		polishDescription:
			"Hormon regulujący cykle snu i czuwania oraz rytmy dobowe",
		activeCompounds: [
			{
				name: "Melatonin",
				polishName: "Melatonina",
		...
		mechanisms: [
			{
				...
				description:
					"Binds to MT1/MT2 receptors in SCN to regulate sleep-wake cycle",
				polishDescription:
					"Wiąże się z receptorami MT1/MT2 w SCN w celu regulacji cyklu snu i czuwania",
				evidenceLevel: "STRONG" as EvidenceLevel,
			...
			interactions: [
				{
					...
					polishClinicalSignificance:
						"Może powodować nadmierną senność w ciągu dnia",
					recommendation: "Reduce melatonin dose or avoid concurrent use",
					polishRecommendation:
						"Zmniejsz dawkę melatoniny lub unikaj jednoczesnego stosowania",
					evidenceLevel: "STRONG" as EvidenceLevel,
				},
			],
		},
	...
	// 4. PQQ (PYRROLOQUINOLINE QUINONE)
	{
		...
		description:
			"Redox cofactor that supports mitochondrial function and cellular energy",
		polishDescription:
			"Kofaktor redoks wspierający funkcję mitochondriów i energię komórkową",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				description:
					"Activates nuclear respiratory factor 1 to promote mitochondrial biogenesis",
				polishDescription:
					"Aktywuje jądrowy czynnik oddechowy 1 w celu promowania biogenezy mitochondriów",
				evidenceLevel: "MODERATE" as EvidenceLevel,
			...
			interactions: [
				{
					...
					polishDescription:
						"PQQ może chronić komórki nowotworowe przed chemioterapią",
	...
	// 5. VITAMIN C (ASCORBIC ACID)
	{
		...
		polishDescription:
			"Niezbędna witamina antyoksydacyjna wspierająca funkcję odpornościową i syntezę kolagenu",
		activeCompounds: [
			{
				name: "Ascorbic acid",
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Oddaje elektrony w celu neutralizacji reaktywnych form tlenu",
				evidenceLevel: "STRONG" as EvidenceLevel,
		...
		dosageGuidelines: {
			...
			polishContraindications: [
				...
				"Zaburzenia przeładowania żelazem",
			],
			interactions: [
				{
					...
					polishClinicalSignificance:
						"Monitoruj działania niepożądane związane z estrogenami",
					recommendation: "Generally safe, monitor if needed",
					polishRecommendation:
						"Ogólnie bezpieczne, monitoruj w razie potrzeby",
					evidenceLevel: "WEAK" as EvidenceLevel,
				},
			],
		},
		...
		researchStudies: [
			{
				...
				polishFindings:
					"Regularna suplementacja witaminą C skraca czas trwania przeziębienia",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 6. 5-HTP (5-HYDROXYTRYPTOPHAN)
	{
		...
		description:
			"Amino acid precursor to serotonin, used for mood and sleep support",
		polishDescription:
			"Prekursor aminokwasowy serotoniny, stosowany w wsparciu nastroju i snu",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				description:
					"Converted to serotonin by aromatic amino acid decarboxylase",
				polishDescription:
					"Przekształcany w serotoninę przez dekarboksylazę aminokwasów aromatycznych",
				evidenceLevel: "STRONG" as EvidenceLevel,
	...
	// 7. MAGNESIUM (COMPREHENSIVE SAFETY PROFILE)
	{
		...
		description:
			"Essential mineral for muscle function, nerve transmission, and energy production",
		polishDescription:
			"Niezbędny minerał dla funkcji mięśniowej, transmisji nerwowej i produkcji energii",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				description:
					"Blocks NMDA receptors to reduce excitatory neurotransmission",
				polishDescription:
					"Blokuje receptory NMDA w celu zmniejszenia pobudliwej neurotransmisji",
				evidenceLevel: "STRONG" as EvidenceLevel,
	...
	// 8. OMEGA-3 FATTY ACIDS (COMPREHENSIVE SAFETY)
	{
		...
		description:
			"Essential fatty acids supporting brain health, cardiovascular function, and inflammation regulation",
		polishDescription:
			"Niezbędne kwasy tłuszczowe wspierające zdrowie mózgu, funkcję sercowo-naczyniową i regulację zapalenia",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				description:
					"EPA converted to resolvins that actively resolve inflammation",
				polishDescription:
					"EPA przekształcany w resolwiny, które aktywnie rozwiązują zapalenie",
				evidenceLevel: "STRONG" as EvidenceLevel,
			...
			interactions: [
				{
					...
					polishMechanism:
						"Kwasy omega-3 mają łagodne działanie antykoagulacyjne",
	...
	// 9. VITAMIN D3 (CHOLECALCIFEROL)
	{
		...
		category: "VITAMIN" as SupplementCategory,
		description:
			"Steroid hormone essential for bone health, immune function, and calcium metabolism",
		polishDescription:
			"Hormon steroidowy niezbędny dla zdrowia kości, funkcji odpornościowej i metabolizmu wapnia",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				description:
					"Binds VDR to regulate gene transcription for calcium absorption",
				polishDescription:
					"Wiąże VDR w celu regulacji transkrypcji genów dla wchłaniania wapnia",
				evidenceLevel: "STRONG" as EvidenceLevel,
	...
	// 10. BACOPA MONNIERI
	{
		...
		description:
			"Ayurvedic herb traditionally used for cognitive enhancement and memory improvement",
		polishDescription:
			"Zioło ajurwedyjskie tradycyjnie stosowane w celu poprawy funkcji poznawczych i pamięci",
		activeCompounds: [
			{
				name: "Bacosides",
				polishName: "Bakozydy",
		...
		mechanisms: [
			{
				...
				description:
					"Increases acetylcholine levels and enhances cholinergic transmission",
				polishDescription:
					"Zwiększa poziom acetylocholiny i wzmacnia transmisję cholinergiczną",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 11. L-THEANINE
	{
		...
		category: "AMINO_ACID" as SupplementCategory,
		description:
			"Amino acid found in tea that promotes relaxation and cognitive enhancement",
		polishDescription:
			"Aminokwas występujący w herbacie, który promuje relaksację i poprawę funkcji poznawczych",
		activeCompounds: [
			{
				name: "L-Theanine",
				polishName: "L-Teanina",
		...
		mechanisms: [
			{
				...
				description:
					"Increases GABA levels and enhances inhibitory neurotransmission",
				polishDescription:
					"Zwiększa poziom GABA i wzmacnia hamującą neurotransmisję",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 12. CREATINE MONOHYDRATE
	{
		...
		category: "AMINO_ACID" as SupplementCategory,
		description:
			"Amino acid derivative essential for cellular energy production and muscle function",
		polishDescription:
			"Pochodna aminokwasu niezbędna dla produkcji energii komórkowej i funkcji mięśniowej",
		activeCompounds: [
			{
				name: "Creatine monohydrate",
				polishName: "Monohydrat kreatyny",
	...
	// 13. RHODIOLA ROSEA
	{
		...
		description:
			"Adaptogenic herb that helps the body adapt to stress and improve mental performance",
		polishDescription:
			"Zioło adaptogenne, które pomaga organizmowi przystosować się do stresu i poprawić sprawność umysłową",
		activeCompounds: [
			{
				name: "Rosavins",
				polishName: "Rozawiny",
		...
		mechanisms: [
			{
				...
				description:
					"Normalizes stress hormone levels and improves stress resilience",
				polishDescription:
					"Normalizuje poziom hormonów stresu i poprawia odporność na stres",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 14. ASHWAGANDHA
	{
		...
		category: "ADAPTOGEN" as SupplementCategory,
		description:
			"Ancient Ayurvedic herb used for stress reduction and vitality enhancement",
		polishDescription:
			"Starożytne zioło ajurwedyjskie stosowane w redukcji stresu i wzmacnianiu witalności",
		activeCompounds: [
			{
				name: "Withanolides",
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Zmniejsza poziom kortyzolu i poprawia odporność na stres",
				evidenceLevel: "MODERATE" as EvidenceLevel,
				targetSystems: ["Endocrine system", "Nervous system"],
				timeToEffect: "2-4 weeks",
				duration: "Ongoing",
	...
	// 15. LION'S MANE MUSHROOM
	{
		...
		category: "HERB" as SupplementCategory,
		description:
			"Medicinal mushroom traditionally used for cognitive enhancement and nerve health",
		polishDescription:
			"Grzyb leczniczy tradycyjnie stosowany w poprawie funkcji poznawczych i zdrowia nerwów",
		activeCompounds: [
			{
				name: "Hericenones",
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Stymuluje produkcję NGF w celu wsparcia regeneracji nerwów",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 16. ALPHA-GPC
	{
		...
		description:
			"Choline compound that supports cognitive function and neurotransmitter synthesis",
		polishDescription:
			"Związek choliny wspierający funkcję poznawczą i syntezę neuroprzekaźników",
		activeCompounds: [
			{
				name: "Alpha-GPC",
				polishName: "Alfa-GPC",
		...
		interactions: [
			{
				...
				polishClinicalSignificance:
					"Monitoruj działania niepożądane cholinergiczne",
				recommendation: "Use with caution",
				polishRecommendation: "Stosuj ostrożnie",
				evidenceLevel: "MODERATE" as EvidenceLevel,
			},
	...
	// 17. CURCUMIN
	{
		...
		category: "HERB" as SupplementCategory,
		description:
			"Active compound from turmeric with potent anti-inflammatory and antioxidant effects",
		polishDescription:
			"Aktywny związek z kurkumy o silnym działaniu przeciwzapalnym i antyoksydacyjnym",
		activeCompounds: [
			{
				name: "Curcumin",
				polishName: "Kurkumina",
		...
		mechanisms: [
			{
				...
				description:
					"Blocks NF-κB activation to reduce inflammatory cytokine production",
				polishDescription:
					"Blokuje aktywację NF-κB w celu zmniejszenia produkcji cytokin zapalnych",
				evidenceLevel: "STRONG" as EvidenceLevel,
	...
	// 18. ACETYL-L-CARNITINE
	{
		...
		category: "AMINO_ACID" as SupplementCategory,
		description:
			"Amino acid derivative that supports mitochondrial function and cognitive health",
		polishDescription:
			"Pochodna aminokwasu wspierająca funkcję mitochondriów i zdrowie poznawcze",
		activeCompounds: [
			{
				name: "Acetyl-L-carnitine",
				polishName: "Acetyl-L-karnityna",
		...
		clinicalApplications: [
			{
				...
				polishIndication:
					"Spadek funkcji poznawczych związany z wiekiem, wsparcie pamięci",
				efficacy: "moderate",
				effectivenessRating: 7.0,
				evidenceLevel: "MODERATE" as EvidenceLevel,
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Ułatwia transport kwasów tłuszczowych do mitochondriów w celu produkcji energii",
				evidenceLevel: "STRONG" as EvidenceLevel,
		...
		interactions: [
			{
				...
				polishDescription:
					"Może zmniejszać skuteczność leków przeciwdrgawkowych",
	...
	// 19. RESVERATROL
	{
		...
		category: "OTHER" as SupplementCategory,
		description:
			"Polyphenol compound with potent antioxidant and anti-aging effects",
		polishDescription:
			"Związek polifenolowy o silnym działaniu antyoksydacyjnym i przeciwstarzeniowym",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				description:
					"Activates SIRT1 to promote cellular longevity and stress resistance",
				polishDescription:
					"Aktywuje SIRT1 w celu promowania długowieczności komórkowej i odporności na stres",
				evidenceLevel: "MODERATE" as EvidenceLevel,
		...
		interactions: [
			{
				...
				polishClinicalSignificance:
					"Monitoruj działanie związane z estrogenami",
				recommendation: "Use with caution in hormone-sensitive conditions",
				polishRecommendation:
					"Stosuj ostrożnie w stanach wrażliwych na hormony",
				evidenceLevel: "MODERATE" as EvidenceLevel,
			},
		],
		evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 20. QUERCETIN
	{
		...
		category: "OTHER" as SupplementCategory,
		description:
			"Flavonoid compound with potent antioxidant and anti-inflammatory properties",
		polishDescription:
			"Związek flawonoidowy o silnych właściwościach antyoksydacyjnych i przeciwzapalnych",
		activeCompounds: [
			{
				name: "Quercetin",
				polishName: "Kwercetyna",
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Stabilizuje komórki tuczne w celu zmniejszenia uwalniania histaminy",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 21. NIACIN (VITAMIN B3)
	{
		...
		category: "VITAMIN" as SupplementCategory,
		description:
			"Essential vitamin for energy metabolism and cardiovascular health",
		polishDescription:
			"Niezbędna witamina dla metabolizmu energetycznego i zdrowia sercowo-naczyniowego",
		activeCompounds: [
			{
				name: "Nicotinic acid",
		...
		clinicalApplications: [
			{
				...
				polishIndication:
					"Redukcja cholesterolu LDL, ryzyko sercowo-naczyniowe",
				efficacy: "high",
				effectivenessRating: 8.5,
				evidenceLevel: "STRONG" as EvidenceLevel,
				recommendedDose: "1000-2000mg daily",
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Zwiększa cholesterol HDL i zmniejsza cholesterol LDL",
				evidenceLevel: "STRONG" as EvidenceLevel,
			...
			interactions: [
				{
					...
					polishClinicalSignificance:
						"Monitoruj funkcję wątroby i objawy mięśniowe",
		...
		sideEffects: [
			{
				...
				polishManagement:
					"Użyj formy o przedłużonym uwalnianiu lub przyjmuj aspirynę",
			},
			{
	...
	// 22. FOLATE (VITAMIN B9)
	{
		...
		category: "VITAMIN" as SupplementCategory,
		description:
			"Essential vitamin for DNA synthesis, methylation, and red blood cell formation",
		polishDescription:
			"Niezbędna witamina dla syntezy DNA, metylacji i tworzenia czerwonych krwinek",
		activeCompounds: [
			{
				name: "L-methylfolate",
		...
		mechanisms: [
			{
				...
				polishPathway: "Metabolizm jednowęglowy",
				description:
					"Essential for DNA methylation and homocysteine metabolism",
				polishDescription:
					"Niezbędny dla metylacji DNA i metabolizmu homocysteiny",
				evidenceLevel: "STRONG" as EvidenceLevel,
				targetSystems: ["Nervous system", "Cardiovascular system"],
				timeToEffect: "2-4 weeks",
				duration: "Ongoing",
			...
			interactions: [
				{
					...
					polishClinicalSignificance:
						"Może zmniejszać skuteczność chemioterapii",
		...
		interactions: [
			{
				...
				polishDescription:
					"Niektóre leki przeciwdrgawkowe zmniejszają poziom folianów",
	...
	// 23. ZINC
	{
		...
		category: "MINERAL" as SupplementCategory,
		description:
			"Essential mineral for immune function, wound healing, and hormone production",
		polishDescription:
			"Niezbędny minerał dla funkcji odpornościowej, gojenia ran i produkcji hormonów",
		activeCompounds: [
			{
				name: "Zinc gluconate",
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Niezbędny dla dojrzewania limfocytów T i odpowiedzi odpornościowej",
				evidenceLevel: "STRONG" as EvidenceLevel,
	...
	// 24. SELENIUM
	{
		...
		category: "MINERAL" as SupplementCategory,
		description:
			"Essential trace mineral with potent antioxidant and immune-modulating effects",
		polishDescription:
			"Niezbędny pierwiastek śladowy o silnym działaniu antyoksydacyjnym i immunomodulującym",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Niezbędny kofaktor dla enzymów peroksydazy glutationowej",
				evidenceLevel: "STRONG" as EvidenceLevel,
	...
	// 25. IRON
	{
		...
		category: "MINERAL" as SupplementCategory,
		description:
			"Essential mineral for oxygen transport, energy production, and immune function",
		polishDescription:
			"Niezbędny minerał dla transportu tlenu, produkcji energii i funkcji odpornościowej",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Niezbędny składnik hemoglobiny dla transportu tlenu",
				evidenceLevel: "STRONG" as EvidenceLevel,
	...
	// 26. MAGNESIUM GLYCINATE
	{
		...
		category: "MINERAL" as SupplementCategory,
		description:
			"Highly bioavailable form of magnesium with excellent absorption and tolerability",
		polishDescription:
			"Wysoce biodostępna forma magnezu o doskonałym wchłanianiu i tolerancji",
		activeCompounds: [
			{
				name: "Magnesium glycinate",
				polishName: "Glicynian magnezu",
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Blokuje receptory NMDA w celu promowania relaksacji i snu",
				evidenceLevel: "MODERATE" as EvidenceLevel,
				targetSystems: ["Nervous system", "Muscular system"],
				timeToEffect: "1-2 hours",
				duration: "6-8 hours",
	...
	// 27. VITAMIN K2 (MK-7)
	{
		...
		category: "VITAMIN" as SupplementCategory,
		description:
			"Essential vitamin for bone health, cardiovascular function, and calcium metabolism",
		polishDescription:
			"Niezbędna witamina dla zdrowia kości, funkcji sercowo-naczyniowej i metabolizmu wapnia",
		activeCompounds: [
			{
				name: "Menaquinone-7",
	...
	// 28. COENZYME Q10
	{
		...
		category: "COENZYME" as SupplementCategory,
		description:
			"Essential coenzyme for mitochondrial energy production and antioxidant protection",
		polishDescription:
			"Niezbędny koenzym dla produkcji energii mitochondrialnej i ochrony antyoksydacyjnej",
		activeCompounds: [
			{
				name: "Ubiquinol",
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Niezbędny składnik mitochondrialnego łańcucha oddechowego",
				evidenceLevel: "STRONG" as EvidenceLevel,
			...
			interactions: [
				{
					...
					polishDescription:
						"Suplementacja CoQ10 może zapobiegać miopatii statinowej",
					clinicalSignificance: "May reduce statin side effects",
					polishClinicalSignificance:
						"Może zmniejszać działania niepożądane statyn",
					recommendation: "Beneficial combination",
					polishRecommendation: "Korzystne połączenie",
					evidenceLevel: "MODERATE" as EvidenceLevel,
				},
	...
	// 29. PYCNOGENOL
	{
		...
		category: "HERB" as SupplementCategory,
		description:
			"Maritime pine bark extract with potent antioxidant and anti-inflammatory effects",
		polishDescription:
			"Ekstrakt z kory sosny nadmorskiej o silnym działaniu antyoksydacyjnym i przeciwzapalnym",
		activeCompounds: [
			{
				name: "Procyanidins",
		...
		clinicalApplications: [
			{
				...
				polishIndication:
					"Choroba zwyrodnieniowa stawów, ból i zapalenie stawów",
				efficacy: "moderate",
				effectivenessRating: 7.0,
				evidenceLevel: "MODERATE" as EvidenceLevel,
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Silny antyoksydant z efektami ochronnymi dla kolagenu",
				evidenceLevel: "MODERATE" as EvidenceLevel,
		...
		researchStudies: [
			{
				...
				polishFindings:
					"Pycnogenol zmniejsza objawy choroby zwyrodnieniowej stawów",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 30. L-GLUTAMINE
	{
		...
		category: "AMINO_ACID" as SupplementCategory,
		description:
			"Most abundant amino acid in the body, essential for gut health and immune function",
		polishDescription:
			"Najbardziej obfity aminokwas w organizmie, niezbędny dla zdrowia jelit i funkcji odpornościowej",
		activeCompounds: [
			{
				name: "L-Glutamine",
				polishName: "L-Glutamina",
		...
		clinicalApplications: [
			{
				...
				polishIndication:
					"Przepuszczalne jelita, IBS, funkcja bariery jelitowej",
				efficacy: "moderate",
				effectivenessRating: 7.0,
				evidenceLevel: "MODERATE" as EvidenceLevel,
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Wspiera integralność bariery jelitowej i zmniejsza przepuszczalność",
				evidenceLevel: "MODERATE" as EvidenceLevel,
				targetSystems: ["Gastrointestinal system", "Immune system"],
				timeToEffect: "1-2 weeks",
				duration: "Ongoing",
	...
	// 31. BETA-ALANINE
	{
		...
		category: "AMINO_ACID" as SupplementCategory,
		description:
			"Non-essential amino acid that increases muscle carnosine levels for improved performance",
		polishDescription:
			"Nieistotny aminokwas, który zwiększa poziom karnozyny w mięśniach dla poprawionej sprawności",
		activeCompounds: [
			{
				name: "Beta-alanine",
				polishName: "Beta-alanina",
		...
		clinicalApplications: [
			{
				...
				polishIndication:
					"Wysiłek o wysokiej intensywności, wytrzymałość, siła",
				efficacy: "high",
		...
		mechanisms: [
			{
				...
				description:
					"Increases muscle carnosine levels for improved buffering capacity",
				polishDescription:
					"Zwiększa poziom karnozyny w mięśniach dla poprawionej zdolności buforowania",
				evidenceLevel: "STRONG" as EvidenceLevel,
				targetSystems: ["Muscular system", "Energy metabolism"],
				timeToEffect: "2-4 weeks",
				duration: "Ongoing",
		...
		sideEffects: [
			{
				...
				polishManagement:
					"Zmniejsz dawkę lub użyj formy o przedłużonym uwalnianiu",
			},
		],
		interactions: [
			{
		...
		researchStudies: [
			{
				...
				polishFindings:
					"Beta-alanina poprawia sprawność wysiłku o wysokiej intensywności",
				evidenceLevel: "STRONG" as EvidenceLevel,
	...
	// 32. TAURINE
	{
		...
		category: "AMINO_ACID" as SupplementCategory,
		description:
			"Semi-essential amino acid with antioxidant and neuroprotective properties",
		polishDescription:
			"Półistotny aminokwas o właściwościach antyoksydacyjnych i neuroprotekcyjnych",
		activeCompounds: [
			{
				name: "Taurine",
				polishName: "Tauryna",
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Reguluje wewnątrzkomórkowy poziom wapnia w mięśniu sercowym",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 33. CITICOLINE
	{
		...
		category: "NOOTROPIC" as SupplementCategory,
		description:
			"Choline compound that supports brain health and cognitive function",
		polishDescription:
			"Związek choliny wspierający zdrowie mózgu i funkcję poznawczą",
		activeCompounds: [
			{
				name: "Citicoline",
				polishName: "Cytikolina",
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Dostarcza cholinę i cytydynę do syntezy fosfolipidów",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 34. GREEN TEA EXTRACT
	{
		...
		category: "HERB" as SupplementCategory,
		description:
			"Concentrated extract from green tea leaves with potent antioxidant and metabolic effects",
		polishDescription:
			"Skoncentrowany ekstrakt z liści zielonej herbaty o silnym działaniu antyoksydacyjnym i metabolicznym",
		activeCompounds: [
			{
				name: "EGCG",
				polishName: "EGCG",
		...
		mechanisms: [
			{
				...
				description:
					"Multiple mechanisms including antioxidant and metabolic effects",
				polishDescription:
					"Wielokrotne mechanizmy obejmujące efekty antyoksydacyjne i metaboliczne",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 35. BERBERINE
	{
		...
		category: "HERB" as SupplementCategory,
		description:
			"Plant alkaloid with potent metabolic and antimicrobial effects",
		polishDescription:
			"Alkaloid roślinny o silnym działaniu metabolicznym i przeciwbakteryjnym",
		activeCompounds: [
			{
				name: "Berberine",
				polishName: "Berberyna",
		...
		mechanisms: [
			{
				...
				description:
					"Activates AMPK to improve insulin sensitivity and glucose metabolism",
				polishDescription:
					"Aktywuje AMPK w celu poprawy wrażliwości na insulinę i metabolizmu glukozy",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 36. ASTAXANTHIN
	{
		...
		category: "OTHER" as SupplementCategory,
		description:
			"Potent carotenoid antioxidant with superior free radical scavenging capacity",
		polishDescription:
			"Silny karotenoidowy antyoksydant o doskonałej zdolności zmiatania wolnych rodników",
		activeCompounds: [
			{
				name: "Astaxanthin",
				polishName: "Astaksantyna",
		...
		clinicalApplications: [
			{
				...
				polishIndication:
					"Degeneracja plamki żółtej, zmęczenie oczu, zmęczenie wzroku",
				efficacy: "moderate",
				effectivenessRating: 7.0,
				evidenceLevel: "MODERATE" as EvidenceLevel,
		...
		mechanisms: [
			{
				...
				polishPathway: "Zmiatanie wolnych rodników",
				description:
					"Crosses blood-brain and blood-retina barriers for superior protection",
				polishDescription:
					"Przekracza bariery krew-mózg i krew-siatkówka dla doskonałej ochrony",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 37. PHOSPHATIDYLSERINE
	{
		...
		category: "OTHER" as SupplementCategory,
		description:
			"Phospholipid essential for cell membrane integrity and stress hormone regulation",
		polishDescription:
			"Fosfolipid niezbędny dla integralności błony komórkowej i regulacji hormonów stresu",
		activeCompounds: [
			{
				name: "Phosphatidylserine",
				polishName: "Fosfatydyloseryna",
	...
	// 38. GINSENG (PANAX GINSENG)
	{
		...
		category: "ADAPTOGEN" as SupplementCategory,
		description:
			"Ancient adaptogenic herb used for energy, cognitive function, and stress resistance",
		polishDescription:
			"Starożytne zioło adaptogenne stosowane dla energii, funkcji poznawczych i odporności na stres",
		activeCompounds: [
			{
				name: "Ginsenosides",
	...
	// 39. RIBOSE (D-RIBOSE)
	{
		...
		category: "OTHER" as SupplementCategory,
		description:
			"Five-carbon sugar essential for ATP production and cellular energy metabolism",
		polishDescription:
			"Cukier pięciowęglowy niezbędny dla produkcji ATP i metabolizmu energii komórkowej",
		activeCompounds: [
			{
				name: "D-Ribose",
				polishName: "D-Ryboza",
		...
		clinicalApplications: [
			{
				...
				polishIndication:
					"Zmęczenie chroniczne, fibromialgia, niewydolność serca",
				efficacy: "moderate",
				effectivenessRating: 7.0,
				evidenceLevel: "MODERATE" as EvidenceLevel,
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Dostarcza rybozę do syntezy ATP i produkcji energii",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 40. TYROSINE
	{
		...
		category: "AMINO_ACID" as SupplementCategory,
		description:
			"Amino acid precursor to catecholamine neurotransmitters dopamine, norepinephrine, and epinephrine",
		polishDescription:
			"Prekursor aminokwasowy katecholaminowych neuroprzekaźników dopaminy, norepinefryny i epinefryny",
		activeCompounds: [
			{
				name: "L-Tyrosine",
		...
		mechanisms: [
			{
				...
				description:
					"Provides tyrosine for catecholamine neurotransmitter production",
				polishDescription:
					"Dostarcza tyrozynę do produkcji katecholaminowych neuroprzekaźników",
				evidenceLevel: "STRONG" as EvidenceLevel,
	...
	// 41. NADH (NICOTINAMIDE ADENINE DINUCLEOTIDE)
	{
		...
		category: "COENZYME" as SupplementCategory,
		description:
			"Reduced form of NAD+ essential for cellular energy production and antioxidant protection",
		polishDescription:
			"Zredukowana forma NAD+ niezbędna dla produkcji energii komórkowej i ochrony antyoksydacyjnej",
		activeCompounds: [
			{
				name: "NADH",
				polishName: "NADH",
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Niezbędny kofaktor dla mitochondrialnej produkcji energii",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 42. PYRIDOXAL-5-PHOSPHATE (P5P)
	{
		...
		category: "VITAMIN" as SupplementCategory,
		description:
			"Active form of vitamin B6 essential for amino acid metabolism and neurotransmitter synthesis",
		polishDescription:
			"Aktywna forma witaminy B6 niezbędna dla metabolizmu aminokwasów i syntezy neuroprzekaźników",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				description:
					"Essential cofactor for amino acid metabolism and neurotransmitter synthesis",
				polishDescription:
					"Niezbędny kofaktor dla metabolizmu aminokwasów i syntezy neuroprzekaźników",
				evidenceLevel: "STRONG" as EvidenceLevel,
	...
	// 43. UBIQUINOL (REDUCED COQ10)
	{
		...
		category: "COENZYME" as SupplementCategory,
		description:
			"Reduced, active form of CoQ10 with superior bioavailability for energy production",
		polishDescription:
			"Zredukowana, aktywna forma CoQ10 o doskonałej biodostępności dla produkcji energii",
		activeCompounds: [
			{
				name: "Ubiquinol",
				polishName: "Ubichinol",
		...
		clinicalApplications: [
			{
				...
				polishIndication:
					"Stres oksydacyjny, starzenie, zdrowie sercowo-naczyniowe",
				efficacy: "moderate",
				effectivenessRating: 7.5,
				evidenceLevel: "MODERATE" as EvidenceLevel,
				recommendedDose: "100-300mg daily",
		...
		mechanisms: [
			{
				...
				polishPathway: "Zmiatanie wolnych rodników",
				description:
					"Regenerates other antioxidants and protects cell membranes",
				polishDescription:
					"Regeneruje inne antyoksydanty i chroni błony komórkowe",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 44. TRIMETHYLGLYCINE (TMG)
	{
		...
		category: "OTHER" as SupplementCategory,
		description:
			"Methyl donor compound that supports methylation and liver health",
		polishDescription:
			"Związek donor metylu wspierający metylację i zdrowie wątroby",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				description:
					"Provides methyl groups for DNA methylation and homocysteine metabolism",
				polishDescription:
					"Dostarcza grupy metylu dla metylacji DNA i metabolizmu homocysteiny",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 45. N-ACETYL CYSTEINE (NAC)
	{
		...
		category: "AMINO_ACID" as SupplementCategory,
		description:
			"Amino acid derivative with potent antioxidant and mucolytic properties",
		polishDescription:
			"Pochodna aminokwasu o silnych właściwościach antyoksydacyjnych i mukolitycznych",
		activeCompounds: [
			{
	...
	// 46. ALPHA LIPOIC ACID
	{
		...
		polishDescription:
			"Uniwersalny antyoksydant, który regeneruje inne antyoksydanty i wspiera metabolizm glukozy",
		activeCompounds: [
			{
				name: "Alpha lipoic acid",
				polishName: "Kwas alfa-liponowy",
	...
	// 47. GRAPE SEED EXTRACT
	{
		...
		category: "HERB" as SupplementCategory,
		description:
			"Rich source of oligomeric proanthocyanidins with potent antioxidant and vascular benefits",
		polishDescription:
			"Bogate źródło oligomerycznych proantocyjanidyn o silnych korzyściach antyoksydacyjnych i naczyniowych",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Wzmacnia ściany naczyń krwionośnych i poprawia krążenie",
				evidenceLevel: "MODERATE" as EvidenceLevel,
		...
		researchStudies: [
			{
				...
				polishTitle:
					"Ekstrakt z pestek winogron dla zdrowia sercowo-naczyniowego",
				...
				polishFindings:
					"Ekstrakt z pestek winogron poprawia markery sercowo-naczyniowe",
				evidenceLevel: "MODERATE" as EvidenceLevel,
	...
	// 48. L-CITRULLINE
	{
		...
		category: "AMINO_ACID" as SupplementCategory,
		description:
			"Amino acid that increases nitric oxide production for improved blood flow and exercise performance",
		polishDescription:
			"Aminokwas, który zwiększa produkcję tlenku azotu dla poprawionego przepływu krwi i sprawności wysiłkowej",
		activeCompounds: [
			{
				name: "L-Citrulline",
				polishName: "L-Cytrulina",
		...
		mechanisms: [
			{
				...
				description:
					"Converted to arginine to increase nitric oxide production",
				polishDescription:
					"Przekształcany w argininę w celu zwiększenia produkcji tlenku azotu",
				evidenceLevel: "MODERATE" as EvidenceLevel,
				targetSystems: ["Cardiovascular system", "Muscular system"],
				timeToEffect: "1-2 hours",
				duration: "4-6 hours",
	...
	// 49. DHEA (DEHYDROEPIANDROSTERONE)
	{
		...
		category: "OTHER" as SupplementCategory,
		description:
			"Steroid hormone precursor with effects on mood, energy, and hormone balance",
		polishDescription:
			"Prekursor hormonów steroidowych o wpływie na nastrój, energię i równowagę hormonalną",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				polishDescription:
					"Przekształcany w testosteron i estrogen w razie potrzeby",
				evidenceLevel: "MODERATE" as EvidenceLevel,
				targetSystems: ["Endocrine system", "Nervous system"],
				timeToEffect: "2-4 weeks",
				duration: "Ongoing",
	...
	// 50. PANTOTHENIC ACID (VITAMIN B5)
	{
		...
		category: "VITAMIN" as SupplementCategory,
		description:
			"Essential vitamin for energy metabolism, hormone synthesis, and adrenal function",
		polishDescription:
			"Niezbędna witamina dla metabolizmu energetycznego, syntezy hormonów i funkcji nadnerczy",
		activeCompounds: [
			{
		...
		mechanisms: [
			{
				...
				polishPathway: "Metabolizm energetyczny",
				description:
					"Essential for coenzyme A production and fatty acid metabolism",
				polishDescription:
					"Niezbędny dla produkcji koenzymu A i metabolizmu kwasów tłuszczowych",
				evidenceLevel: "STRONG" as EvidenceLevel,
				targetSystems: ["Metabolic system", "Endocrine system"],
				timeToEffect: "1-2 weeks",
				duration: "Ongoing",
		...
		interactions: [
			{
				...
				clinicalSignificance:
					"Enhanced methylation and red blood cell formation",
			},
		],
		synergies: [],
		contraindications: ["Leber's hereditary optic neuropathy"],
...
export const supplementSynergies: SupplementSynergy[] = [
	{
		...
		description:
			"Comprehensive methylation support for optimal homocysteine metabolism",
		polishDescription:
			"Kompleksowe wsparcie metylacji dla optymalnego metabolizmu homocysteiny",
...
export const evidenceBasedRecommendations = {
	highEvidence: comprehensiveSupplements.filter(
		(s) => s.evidenceLevel === "STRONG",
	),
	moderateEvidence: comprehensiveSupplements.filter(
		(s) => s.evidenceLevel === "MODERATE",
	),
	lowEvidence: comprehensiveSupplements.filter(
...
export const safetyProfiles = {
	lowRisk: comprehensiveSupplements.filter(
		(s) => s.dosageGuidelines.therapeuticRange.max < 1000,
	),
	moderateRisk: comprehensiveSupplements.filter(
		(s) =>
			s.dosageGuidelines.therapeuticRange.max >= 1000 &&
			s.dosageGuidelines.therapeuticRange.max < 5000,
	),
	highRisk: comprehensiveSupplements.filter(
		(s) => s.dosageGuidelines.therapeuticRange.max >= 5000,
	),
...
export function getSupplementById(
	id: string,
): SupplementWithRelations | undefined {
	return comprehensiveSupplements.find((s) => s.id === id);
}

export function getSupplementsByCategory(
	category: SupplementCategory,
): SupplementWithRelations[] {
	return comprehensiveSupplements.filter((s) => s.category === category);
}

export function getSupplementsByEvidenceLevel(
	level: EvidenceLevel,
): SupplementWithRelations[] {
...
export function searchSupplements(query: string): SupplementWithRelations[] {
	...
	return comprehensiveSupplements.filter(
		(s) =>
...
export function validateSupplementData(): {
	isValid: boolean;
	errors: string[];
} {
	const errors: string[] = [];
...
export const supplementDatabaseMetadata = {
	...
	categories: Array.from(
		new Set(comprehensiveSupplements.map((s) => s.category)),
	),
	evidenceLevels: Array.from(
		new Set(comprehensiveSupplements.map((s) => s.evidenceLevel)),
	),
	highEvidenceCount: comprehensiveSupplements.filter(
		(s) => s.evidenceLevel === "STRONG",
	).length,
	moderateEvidenceCount: comprehensiveSupplements.filter(
		(s) => s.evidenceLevel === "MODERATE",
	).length,
	lowEvidenceCount: comprehensiveSupplements.filter(
		(s) => s.evidenceLevel === "WEAK",
	).length,
	lastUpdated: "2023-12-01T00:00:00Z",
	version: "1.0.0",
...
export function isSupplementWithRelations(
	obj: any,
): obj is SupplementWithRelations {
	return (
		obj &&
		typeof obj === "object" &&
		"id" in obj &&
...
export function isHighEvidenceSupplement(
	supplement: SupplementWithRelations,
): boolean {
	return supplement.evidenceLevel === "STRONG";
}

export function isLowRiskSupplement(
	supplement: SupplementWithRelations,
): boolean {
	return (
		!supplement.sideEffects.some((effect) => effect.severity === "severe") &&
		!supplement.interactions.some(
			(interaction) => interaction.severity === "severe",
		)
	);
}

export function requiresMedicalSupervision(
	supplement: SupplementWithRelations,
): boolean {
	return (
		supplement.sideEffects.some((effect) => effect.severity === "severe") ||
