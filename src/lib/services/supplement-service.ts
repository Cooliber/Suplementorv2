...
export function useSupplements(query: SupplementQuery = {}): SupplementServiceResult<any[]> {
  ...
  const fetchSupplements = async () => {
    ...
    try {
      ...
      loadingState.setLoadingError(error instanceof Error ? error.message : "Nie udało się załadować suplementów");
      throw error;
    }
  };
...
export function useSupplement(id: string): SupplementServiceResult<any> {
  ...
  const fetchSupplement = async () => {
    ...
    try {
      ...
      loadingState.setLoadingError(error instanceof Error ? error.message : "Nie udało się załadować suplementu");
      throw error;
    }
  };
...
export function useSupplementSearch(): {
  ...
  const search = async (term: string) => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : "Nie udało się wyszukać suplementów";
