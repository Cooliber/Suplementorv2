			...
			<CardContent className="space-y-6">
				...
				<div className="grid grid-cols-2 gap-4 md:grid-cols-4">
					<div className="rounded-lg bg-muted p-3 text-center">
						...
						<div className="text-muted-foreground text-sm">Pliki</div>
					</div>
					<div className="rounded-lg bg-muted p-3 text-center">
						<div className="font-bold text-2xl text-green-600">
							{readyFiles.length}
						</div>
						<div className="text-muted-foreground text-sm">Gotowe</div>
					</div>
					<div className="rounded-lg bg-muted p-3 text-center">
						<div className="font-bold text-2xl text-blue-600">
							{processingFiles.length}
						</div>
						<div className="text-muted-foreground text-sm">W trakcie</div>
					</div>
					<div className="rounded-lg bg-muted p-3 text-center">
						<div className="font-bold text-2xl text-orange-600">
							{formatFileSize(totalSize)}
						</div>
						<div className="text-muted-foreground text-sm">Rozmiar</div>
					</div>
				</div>
					...
					<div className="space-y-2">
						<div className="flex justify-between text-sm">
							...
							<span>
								...
								{formatFileSize(storageInfo.used + storageInfo.available)}
							</span>
						</div>
											...
											<div className="flex flex-1 items-center gap-3">
												...
												<div className="min-w-0 flex-1">
													...
													<div className="text-muted-foreground text-sm">
														...
														{file.createdAt.toLocaleDateString("pl-PL")}
													</div>
													{file.error && (
					...
					<div className="rounded-lg border border-orange-200 bg-orange-50 p-3">
						<div className="flex items-center gap-2 text-orange-800">
							...
							<span className="font-medium text-sm">
								Osiągnięto {Math.round((files.length / maxFiles) * 100)}% limitu
								plików
							</span>
						</div>
					</div>
