...
const SUPPLEMENT_TEMPLATES: ExportTemplate[] = [
  {
    ...
    polishDescription: "Podstawowe informacje o suplementach do szybkiego podglądu",
    configuration: {
      format: "csv",
      filename: "podstawowe-suplementy",
      includeAllColumns: false,
    },
    recommendedColumns: ["name", "polishName", "category", "evidenceLevel", "dosage"],
    useCase: "Szybki przegląd suplementów",
  },
  {
    id: "detailed-supplement-analysis",
    name: "Detailed Supplement Analysis",
    description: "Comprehensive supplement data with research and clinical information",
    icon: Database,
    category: "supplements",
    polishName: "Szczegółowa analiza suplementów",
    polishDescription: "Kompletne dane suplementów z informacjami badawczymi i klinicznymi",
    configuration: {
      format: "excel",
  ...
  },
  {
    ...
    recommendedColumns: ["name", "clinicalApplications", "evidenceLevel", "contraindications"],
  ...
  },
  {
    ...
    polishDescription: "Informacje o bezpieczeństwie, efektach ubocznych i interakcjach",
    configuration: {
      format: "pdf",
      filename: "profil-bezpieczenstwa",
      includeAllColumns: false,
    },
    recommendedColumns: ["name", "sideEffects", "interactions", "contraindications", "warnings"],
...
const ANALYTICS_TEMPLATES: ExportTemplate[] = [
  {
    ...
    polishDescription: "Wzorce użytkowania suplementów i analiza częstotliwości",
    configuration: {
      format: "csv",
  ...
  },
  {
    ...
    polishDescription: "Skuteczność suplementów na podstawie opinii i ocen użytkowników",
    configuration: {
      format: "excel",
      filename: "raport-skutecznosci",
      includeAllColumns: false,
    },
    recommendedColumns: ["name", "averageRating", "reviewCount", "effectivenessScore"],
...
const RESEARCH_TEMPLATES: ExportTemplate[] = [
  {
    ...
    recommendedColumns: ["name", "researchCount", "evidenceLevel", "keyFindings"],
  ...
  },
  {
    ...
    recommendedColumns: ["name", "evidenceLevel", "researchCount", "studyTypes", "methodologyQuality"],
