...
export const ExportDialog: React.FC<ExportDialogProps> = ({
  ...
  const currentFormat = EXPORT_FORMATS.find(f => f.value === configuration.format);
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 overflow-hidden">
          ...
          <TabsContent value="columns" className="space-y-4 mt-4">
            ...
            <div className="text-sm text-muted-foreground">
              Wybrano {configuration.selectedColumns.length} z {detectedColumns.length} kolumn
            </div>
          </TabsContent>
          ...
          <TabsContent value="options" className="space-y-4 mt-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="includeMetadata">Dołącz metadane eksportu</Label>
              </div>
            </div>
          </TabsContent>
        ...
        {isExporting && (
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <div className="text-sm font-medium">Eksportowanie...</div>
              <div className="text-sm text-muted-foreground">
                {exportProgress}%
              </div>
            </div>
