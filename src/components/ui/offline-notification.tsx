...
export function OfflineNotification({
	...
	return (
		...
		>
			<Alert
				className={cn(
					"rounded-none border-t-0 border-r-0 border-b-0 border-l-4",
					!isOnline
						? "border-l-orange-500 bg-orange-50"
						: "border-l-green-500 bg-green-50",
				)}
							...
							{!isOnline ? (
								<div>
									...
									<p className="mt-1 text-sm">
										Pracujesz w trybie offline. Niektóre funkcje mogą być
										ograniczone.
										{pendingChanges > 0 && (
											<Badge variant="outline" className="ml-2 text-xs">
												{pendingChanges} oczekujących zmian zostanie
