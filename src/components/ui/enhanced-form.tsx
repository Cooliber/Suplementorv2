...
const validationIndicatorVariants = cva(
  "absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 transition-all duration-200",
  {
    variants: {
      state: {
...
interface ValidationIndicatorProps extends VariantProps<typeof validationIndicatorVariants> {
  className?: string;
}

const ValidationIndicator = React.forwardRef<HTMLDivElement, ValidationIndicatorProps>(
  ({ className, state, ...props }, ref) => {
    ...
    return (
      <div ref={ref} className={cn(validationIndicatorVariants({ state }), className)} {...props}>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <input
            type={inputType}
            className={cn(
              "flex h-10 w-full rounded-md border bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 pr-10",
          ...
          {isPassword && (
            <Button
              ...
              variant="ghost"
              size="sm"
              className="absolute right-10 top-1/2 -translate-y-1/2 h-6 w-6 p-0 hover:bg-transparent"
    ...
    return (
      <div className="space-y-2">
        ...
        <div className="relative">
          <select
            className={cn(
              "flex h-10 w-full rounded-md border bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 pr-10",
              showValidationIndicator && "pr-10",
              getBorderColor(),
              className
            )}
...
const ValidationSummary = React.forwardRef<HTMLDivElement, ValidationSummaryProps>(
