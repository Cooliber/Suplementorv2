...
export type MedicineSystem = "TCM"|"AYURVEDA"|"GREEK_ROMAN"|"EUROPEAN_HERBALISM"|"MODERN_SCIENCE"|"OTHER";

export function MedicineSystemFilter({ value, onChange }: { value?: MedicineSystem|"ALL"; onChange: (v: MedicineSystem|"ALL")=>void }){
  return (
    <div className="flex items-center gap-2">
      ...
      <Select value={value ?? "ALL"} onValueChange={(v)=> onChange(v as any)}>
        ...
        <SelectContent>
          ...
          <SelectItem value="EUROPEAN_HERBALISM">Zielarstwo Europejskie</SelectItem>
