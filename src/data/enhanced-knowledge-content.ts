...
export const ENHANCED_KNOWLEDGE_DATABASE: EnhancedResearchContent[] = [
	{
		...
		polishTitle:
			"Modulacja Mikrogli dla Neuroprotekcji i Wzmacniania Kognitywnego",
		...
		studyReferences: [
			{
				...
				title:
					"Microglial priming states predict cognitive decline progression",
				journal: "Neuron",
				year: 2024,
				impactFactor: 16.2,
				citationCount: 156,
			...
			},
			{
				...
				title:
					"Microglia in brain homeostasis and disease: From bench to bedside",
		...
		keyFindings: [
			{
				finding:
					"Microglial priming states are predictive biomarkers for cognitive trajectory",
				polishFinding:
					"Stany pierwotnej aktywacji mikrogli są przewidującymi biomarkerami trajectory kognitywnej",
				significance: "high",
				clinicalRelevance: 9,
				mechanism:
					"Microglial transition from M2 neuroprotective to M1 pro-inflammatory states correlates with reduced synaptic plasticity and impaired memory consolidation",
				polishMechanism:
					"Przejście mikrogli ze stanu M2 neuroprotekcyjnego do M1 prozapalnego koreluje z redukcją plastyczności synaptycznej i zaburzeniami konsolidacji pamięci",
			},
			{
				finding:
					"Lion's Mane mushroom reverses microglial priming through NGF upregulation",
				polishFinding:
					"Soplówka jeżowata odwraca pierwotną aktywację mikrogli poprzez regulację w górę NGF",
				significance: "high",
				clinicalRelevance: 8,
				mechanism:
					"Polysaccharides from Hericium erinaceus promote microglial polarization to M2 phenotype through STAT6 pathway activation",
				polishMechanism:
					"Polisacharydy z Hericium erinaceus promują polaryzację mikrogli do fenotypu M2 poprzez aktywację ścieżki STAT6",
			},
		],
		practicalApplications: [
			{
				...
				polishApplication:
					"Protokół odporności kognitywnej dla populacji starzejących się",
				context: "neuroprotection",
				implementation:
					"Combination of Lion's Mane (1g daily), omega-3 DHA (1000mg), and low-dose flavonoids for 12 months",
				polishImplementation:
					"Kombinacja Soplówki jeżowatej (1g dziennie), omega-3 DHA (1000mg) i niskich dawek flawonoidów przez 12 miesięcy",
				timeframe: "6-12 months",
				expectedOutcome:
					"30% reduction in cognitive decline rate, improved executive function",
				polishExpectedOutcome:
					"30% redukcji tempa spadku kognitywnego, poprawa funkcji wykonawczych",
				confidence: 78,
			},
		],
		supplementSynergies: [
			{
				...
				mechanism:
					"Enhanced microglial polarization to M2 phenotype when combined with omega-3 fatty acids",
				polishMechanism:
					"Wzmocnienie polaryzacji mikrogli do fenotypu M2 w połączeniu z kwasami omega-3",
				evidenceStrength: 8,
				clinicalData: [
					{
		...
		riskFactors: [
			{
				...
				prevalence: 12,
				mitigation:
					"Regular monitoring of inflammatory markers and cognitive function testing",
				polishMitigation:
					"Regularne monitorowanie markerów zapalnych i testów funkcji kognitywnych",
				evidenceLevel: 7,
			},
		],
	},
	{
		...
		title:
			"Time-Dependent Pharmacology: Optimizing Supplement Timing for Cognitive Enhancement",
		polishTitle:
			"Farmakologia Zależna od Czasu: Optymalizacja Pór Suplementacji dla Wzmacniania Kognitywnego",
		...
		studyReferences: [
			{
				...
				title:
					"Circadian timing of treatment significantly improves drug efficacy and reduces adverse effects",
				journal: "Science",
				year: 2024,
				impactFactor: 44.7,
				citationCount: 298,
		...
		keyFindings: [
			{
				finding:
					"Cognitive performance fluctuates by 20-30% across circadian cycle based on individual chronotype",
				polishFinding:
					"Wydajność kognitywna fluktuuje o 20-30% w całym cyklu okołodobowym w zależności od chronotypu indywidualnego",
				significance: "high",
				clinicalRelevance: 9,
				mechanism:
					"Dopaminergic and cholinergic receptor expression follows circadian rhythm, affecting neurotransmitter availability",
				polishMechanism:
					"Ekspresja receptorów dopaminergicznych i cholinergicznych podlega rytmowi okołodobowemu, wpływając na dostępność neuroprzekaźników",
			},
			{
				finding:
					"Time-targeted supplementation improves efficacy by 2-3x compared to fixed-dose regimens",
				polishFinding:
					"Suplementacja celowana czasowo poprawia skuteczność o 2-3x w porównaniu do schematów o stałej dawce",
				significance: "high",
				clinicalRelevance: 8,
				mechanism:
					"Receptor sensitivity peaks during specific circadian phases, enhancing neurotransmitter modulation",
				polishMechanism:
					"Wrażliwość receptorów osiąga szczyty podczas określonych faz okołodobowych, wzmacniając modulację neuroprzekaźników",
			},
		],
		practicalApplications: [
			{
				...
				context: "cognitive",
				implementation:
					"Morning chronotypes: cognitive enhancers 8-10 AM; Evening chronotypes: 2-4 PM",
				polishImplementation:
					"Chronotypy poranne: wzmacniacze kognitywne 8-10 AM; Chronotypy wieczorne: 2-4 PM",
				timeframe: "Immediate (within 24 hours)",
				expectedOutcome:
					"25% improvement in working memory accuracy, 18% increase in processing speed",
				polishExpectedOutcome:
					"Poprawa dokładności pamięci roboczej o 25%, zwiększenie szybkości przetwarzania o 18%",
				confidence: 85,
			},
			{
				...
				context: "cognitive",
				implementation:
					"Schedule intensive learning during peak cognitive alertness periods matched to supplement absorption",
				polishImplementation:
					"Planuj intensywną naukę podczas okresów szczytowej czujności kognitywnej dopasowanych do wchłaniania suplementów",
				timeframe: "2-3 weeks for adaptation",
				expectedOutcome:
					"40% improvement in information retention, 35% reduction in learning time",
				polishExpectedOutcome:
					"Poprawa retencji informacji o 40%, redukcja czasu nauki o 35%",
				confidence: 78,
			},
		],
		supplementSynergies: [
			{
				...
				synergyType: "synergistic",
				mechanism:
					"Enhanced adenosine receptor antagonism during afternoon alertness dips",
				polishMechanism:
					"Wzmociona antagonizacja receptorów adenozynowych podczas popołudniowych spadków czujności",
				evidenceStrength: 9,
				clinicalData: [
					{
		...
		riskFactors: [
			{
				...
				polishRisk:
					"Zaburzenie rytmu okołodobowego od źle dobranego czasowo suplementowania",
				severity: "medium",
				prevalence: 8,
				mitigation:
					"Use of wearable sleep trackers and cognitive performance apps to identify optimal timing",
				polishMitigation:
					"Używanie noszonych trackerów snu i aplikacji wydajności kognitywnej do identyfikacji optymalnego czasu",
				evidenceLevel: 8,
			},
		],
	},
	{
		...
		title:
			"Microbiome-Mediated Cognitive Enhancement: The Role of Prebiotics in Neurotransmitter Regulation",
		polishTitle:
			"Wzmacnianie Kognitywne Mediated Mikrobiomem: Rola Prebiotyków w Regulacji Neuroprzekaźników",
		category: "clinical",
		difficulty: "advanced",
		...
		studyReferences: [
			{
				...
				title:
					"Microbiota-derived metabolites regulate brain function and behavior",
				journal: "Nature",
				year: 2024,
				impactFactor: 64.8,
				citationCount: 412,
			...
			},
			{
				...
				title:
					"The gut-brain axis: interactions between enteric microbiota and the central nervous system",
				journal: "Gut",
				year: 2024,
				impactFactor: 23.0,
				citationCount: 234,
		...
		keyFindings: [
			{
				finding:
					"Gut microbiome diversity correlates with executive function scores independent of diet",
				polishFinding:
					"Różnorodność mikrobiomu jelitowego koreluje z wynikami funkcji wykonawczych niezależnie od diety",
				significance: "medium",
				clinicalRelevance: 7,
				mechanism:
					"SCFA (short-chain fatty acids) production modulates microglial maturation and synaptic pruning",
				polishMechanism:
					"Produkcja SCFA (krótkołańcuchowych kwasów tłuszczowych) moduluje dojrzewanie mikrogli i przycinanie synaptyczne",
			},
			{
				finding:
					"Prebiotic supplementation increases BDNF levels by 25% in 8 weeks",
				polishFinding:
					"Suplementacja prebiotyczna zwiększa poziomy BDNF o 25% w ciągu 8 tygodni",
				significance: "medium",
				clinicalRelevance: 6,
				mechanism:
					"Gut-derived lactate and butyrate enhance hippocampal neurogenesis via histone acetylation",
				polishMechanism:
					"Pochodzące z jelit mleczan i masłan poprawiają neurogenezę hipokampalną poprzez acetylację histonów",
			},
		],
		practicalApplications: [
			{
				...
				context: "cognitive",
				implementation:
					"5g inulin + 3g GOS daily for 12 weeks with cognitive training",
				polishImplementation:
					"5g inuliny + 3g GOS dziennie przez 12 tygodni z treningiem kognitywnym",
				timeframe: "8-12 weeks",
				expectedOutcome:
					"Improved working memory (15%), better emotional regulation (20%)",
				polishExpectedOutcome:
					"Poprawa pamięci roboczej (15%), lepsza regulacja emocjonalna (20%)",
				confidence: 72,
			},
		],
		supplementSynergies: [
			{
				...
				synergyType: "synergistic",
				mechanism:
					"Enhanced cognitive benefits through neurotransmitter precursor production",
				polishMechanism:
					"Wzmoczone korzyści kognitywne poprzez produkcję prekursorów neuroprzekaźników",
				evidenceStrength: 7,
				clinicalData: [
					{
		...
		riskFactors: [
			{
				...
				prevalence: 25,
				mitigation:
					"Gradual dose titration over 2-3 weeks with adequate hydration",
				polishMitigation:
					"Stopniowa titracja dawki przez 2-3 tygodnie z odpowiednim nawodnieniem",
				evidenceLevel: 6,
			},
		],
	},
...
export const ENHANCED_NEUROTRANSMITTER_PATHWAYS = {
	acetylcholine: {
		...
		description:
			"Primary neurotransmitter for memory formation, attention, and learning",
		polishDescription:
			"Główny neuroprzekaźnik dla tworzenia pamięci, uwagi i uczenia się",
		pathways: [
		...
		newResearch2025: [
			{
				...
				polishFinding:
					"25% wzrost amplitudy LTP po 12 tygodniach suplementacji",
				impact: "Enhanced learning capacity, improved memory consolidation",
				polishImpact:
					"Zwiększona zdolność uczenia się, poprawa konsolidacji pamięci",
			},
		],
	...
	dopamine: {
		...
		polishName: "Dopamina",
		description:
			"Key modulator of reward, motivation, executive function, and motor control",
		polishDescription:
			"Kluczowy modulator nagrody, motywacji, funkcji wykonawczych i kontroli motorycznej",
		pathways: [
		...
		newResearch2025: [
			{
				...
				polishTitle:
					"Optymalizacja okołodobowa terapii dopaminergiczną poprawia adherencję",
				finding:
					"40% better outcomes when dosing aligned to individual chronotype",
				polishFinding:
					"40% lepsze wyniki gdy dawkowanie dopasowane do chronotypu indywidualnego",
		...
		newResearch2025: [
			{
				...
				polishFinding:
					"Bakterie jelitowe przyczyniają się do 90% serotoniny obwodowej",
				impact:
					"New avenue for treating depression and anxiety through microbiome modulation",
				polishImpact:
					"Nowa droga leczenia depresji i lęku poprzez modulację mikrobiomu",
			},
		],
		clinicalApplications: [
			{
	...
	gaba: {
		...
		polishName: "GABA",
		description:
			"Primary inhibitory neurotransmitter for anxiety reduction and sleep regulation",
		polishDescription:
			"Główny neuroprzekaźnik hamujący dla redukcji lęku i regulacji snu",
		pathways: [
		...
		newResearch2025: [
			{
				...
				finding:
					"GABA-A alpha2/3 selective agonists provide anxiolysis without sedation",
				polishFinding:
					"Agoniści selektywni GABA-A alfa2/3 zapewniają działanie przeciwlękowe bez sedacji",
...
export const SUPPLEMENT_INTERACTIONS_2025 = [
	{
		...
		recommendation:
			"Contraindicated - discontinue St. John's Wort 2 weeks before SSRI initiation",
		polishRecommendation:
			"Przeciwwskazane - odstawiej dziurawca św. Jana 2 tygodnie przed rozpoczęciem SSRI",
	},
	{
		...
		recommendation:
			"Monitor INR weekly for 3 weeks, reduce ginkgo dose or discontinue",
		polishRecommendation:
			"Monitoruj INR co tydzień przez 3 tygodnie, redukuj dawkę miłorzębu lub odstawić",
	},
	{
		...
		recommendation:
			"Limit caffeine to <100mg daily, monitor cardiovascular parameters",
		polishRecommendation:
			"Ogranicz kofeinę do <100mg dziennie, monitoruj parametry sercowo-naczyniowe",
	},
];
		...
		lifestyleComponents: [
			{
				...
				protocol:
					"Moderate cardio 30 minutes morning, strength training afternoon",
				polishProtocol:
					"Kardio umiarkowane 30 minut rano, trening siłowy popołudniu",
			...
			},
			{
				...
				protocol:
					"7-9 hours with consistent bedtime, blue light avoidance 2 hours before sleep",
				polishProtocol:
					"7-9 godzin z stałą porą spania, unikanie światła niebieskiego 2 godziny przed snem",
				mechanism: "Glymphatic clearance + memory consolidation enhancement",
				polishMechanism:
					"Oczyszczanie układu limfatycznego + wzmocnienie konsolidacji pamięci",
			},
			{
				name: "Cognitive training",
				polishName: "Trening kognitywny",
				protocol:
					"30 minutes daily of dual n-back tasks, spaced repetition learning",
				polishProtocol:
					"30 minut dziennie zadań podwójnego n-back, uczenie rozproszone",
				mechanism: "Synaptic strengthening through Hebbian plasticity",
				polishMechanism:
					"Wzmocnienie synaptyczne poprzez plastyczność hebiańską",
			},
		],
		monitoringRequired: [
